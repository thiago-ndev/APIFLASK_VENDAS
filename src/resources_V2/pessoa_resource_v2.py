...
class PessoaResource(Resource):
    def get(self, codigo):
        try:
            service = ServiceFactory.get_service('pessoa')
            pessoa = service.get_pessoa(codigo)
            if pessoa:
    ...
    def delete(self, codigo):
        try:
            service = ServiceFactory.get_service('pessoa_service')
            if service:
                service.delete_pessoa(codigo)
